...
namespace Platform
{
    ...
    public sealed partial class GamePage3 : Page
    {
        ...
        public GamePage3()
        {
            ...
            bird = new Bird
            {
                StartLocationXX = CanvasWidth - 1100,
                StartLocationYY = 340
            };
            ...
            flower = new Flower
            {
                LocationX = CanvasWidth - 70,
                LocationY = CanvasHeight - 175
            };

            enemy2 = new enemy2
            {
                StartLocationX = 10,
                StartLocationY = CanvasHeight - 190
            };
        ...
        private void CheckCollision()
        {
            ...
            Rect r2 = new Rect(turtle.StartLocationXX, turtle.StartLocationYY, turtle.ActualWidth, turtle.ActualHeight);
            ...
            // Go to Winpage when touch flower
            r1 = new Rect(character.LocationX, character.LocationY, character.ActualWidth, character.ActualHeight);
            ...
            r1 = new Rect(character.LocationX, character.LocationY, character.ActualWidth, character.ActualHeight);
            Rect r5 = new Rect(bird.StartLocationXX, bird.StartLocationYY, bird.ActualWidth, bird.ActualHeight);
            r1.Intersect(r5);
            // yes if not empty
            if (!r1.IsEmpty)
            {
